...
const Banner = ({query, handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
        <h1 className='text-5xl font-bold text-primary mb-3'>Find your <span className='text-blue'>new StudyMate</span> today</h1>
        <p className='text-lg text-black/70 mb-8'>
        StudyMate connects students seeking study partners based on location, schedules, and academic interests, providing a platform for shared learning experiences.
        </p>
        <form>
          <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
            ...
            focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full'>
              <input type="text" name="title" id="title" placeholder="What studymate are you looking for?" className="block flex-1 border-0 bg-transparent 
          ...
          <div className="flex justify-center mt-8">
              <Link to="/post-listing" className='py-2 px-5 border rounded bg-blue text-white'>Write a Post and find your Ally for your next quest </Link>
          </div>
        </form>
